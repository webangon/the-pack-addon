...
class The_Pack_Woo_Related_Product extends Widget_Base
{
    public function get_name()
    {
        return 'tp_woorelated';
    }

    public function get_title()
    {
        return esc_html__('Woo related', 'the-pack-addon');
    }
    ...
    protected function render()
    {
        ...
        $id = [];
        foreach ( (array) $args["related_products"] as $related_product ){
...
$widgets_manager->register(new \ThePackAddon\Widgets\The_Pack_Woo_Related_Product());
