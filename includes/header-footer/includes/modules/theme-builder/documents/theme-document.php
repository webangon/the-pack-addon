...
abstract class Theme_Document extends Library_Document {
	...
	public static function get_create_url() {
		$base_create_url = thepack_kit()->elementor()->documents->get_create_new_post_url( Source_Local::CPT );
    ...
    public function import( array $data ) {
        ...
        if ( ! empty( $conditions ) ) {
            ...
            if ( $conflicts ) {
                ...
                $import_export_module = thepack_kit()->elementor()->app->get_component( 'import-export' );
                ...
                foreach ( $conflicts as $template ) {
                    ...
                    $template_document = thepack_kit()->documents->get( $template['template_id'] );
